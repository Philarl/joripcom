        ...
        <!--------------------------
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <!-- /.box-header -->
              <div class="box-body">
                <table class="table table-bordered" id="dropList">
                  <tbody><tr>
                  ...
                  <c:forEach items="${dropList }" var="dropVO">
                  <tr>
                    <td class="align-middle"><input type="checkbox" name="check" value="${orderVO.ord_no }"></td>
                    <td class="align-middle">${dropVO.u_id}</td>
                    <td class="align-middle">${dropVO.u_email}</td>
                    <td class="align-middle">${dropVO.u_nic}</td>
                    <td class="align-middle"><fmt:formatDate value="${dropVO.backup_u_date}" pattern="yyyy-MM-dd HH:mm"/></td>
                    <td colspan="2" class="align-middle">
                      <button type="button" name="btn_memberEdit" data-u_id="${dropVO.u_id }" class="btn btn-link">수정</button>
                      <button type="button" name="btn_memberDel" data-u_id="${dropVO.u_id }" class="btn btn-link">삭제</button>
                    </td>
                  </tr>
                  </c:forEach>
