	                ...
	                <div class="card-body">
	                  <div class="form-group row">
	                  	...
	                  	<div class="col-md-2 mb-3">
		                    <label for="btn_idCheck"></label><br>
		                    <button type="button" class="btn btn-primary" id="btn_idCheck">아이디 중복체크</button>
	                    </div>
	                  	<div class="col-md-5 mb-3">
	                  ...
	                  <div class="form-group row">
	                  	...
	                  	<div class="col-md-6 mb-3">
		                    <label for="u_checkpw">비밀번호 확인</label>
		                    <input type="password" class="form-control" name="u_checkpw" id="u_checkpw">
	                    </div>
	                  </div>
	                  <div class="form-group row">
